...
$pagina_destino = rolTieneFuncionesAdmin($tipo_usuario) ? 'menuadmin.php' : 'menu_usuario.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $es_emiliano_libre = esUsuarioEmilianoMachuca($mi_id);
        $rol_bloqueante = obtenerRolBloqueanteFirmaPiv($pdo, $id_piv, $mi_id);
        if (!$es_emiliano_libre && $rol_bloqueante !== null) {
            header("Location: $pagina_destino?msg=jerarquia_bloqueada");
            exit;
        }
