...
if (!in_array($tipo, ['admin', 'ingeniero_forestal', 'jefe_operaciones', 'jefe_faena', 'usuario'], true)) { header("Location: login.php"); exit; }
...
$data = [
  ...
  'vma_m3_arb' => trim((string)($_POST['vma_m3_arb'] ?? '')),
  'superficie_ha' => trim((string)($_POST['superficie_ha'] ?? '')),
  'volumen_total_m3' => trim((string)($_POST['volumen_total_m3'] ?? '')),
  'arboles_hora' => trim((string)($_POST['arboles_hora'] ?? '')),
  'm3_hora' => trim((string)($_POST['m3_hora'] ?? '')),
  ...
  'tiempo_estimado_dias' => trim((string)($_POST['tiempo_estimado_dias'] ?? '')),
  'pendiente_max_pct' => trim((string)($_POST['pendiente_max_pct'] ?? '')),
